...
VL_by_acC.Form = () => {
    ...
    return (
        <form key={formKey} onSubmit={handleSubmit} className="flex flex-col gap-4 bg-white p-6 border border-gray-200 shadow-md rounded-md w-full max-w-md mx-auto">
            <h2 className="text-xl font-semibold text-blue-600">Velocidad Lineal para una a<sub>c</sub> dada</h2>

            <div className="flex flex-col">
                <label htmlFor="radio" className="text-sm font-medium text-gray-700 mb-1">Radio (m):</label>
                <input type="number" id="radio" name="radio" step="any" placeholder="Ej: 0.5" required className="p-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-400" />
            </div>

            <div className="flex flex-col">
                <label htmlFor="ac" className="text-sm font-medium text-gray-700 mb-1">Aceleración centrípeta (m/s²):</label>
                <input type="number" id="ac" name="ac" step="any" placeholder="Ej: 9.8" required className="p-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-400" />
            </div>
