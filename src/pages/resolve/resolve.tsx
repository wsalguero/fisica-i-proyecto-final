    ...
    return (
        <>
            <div className="w-full h-full flex flex-col items-center justify-center text-center py-20">
                <FaCog className="text-6xl text-blue-500 animate-spin mb-4" />
                <h1 className="text-4xl font-bold text-gray-800 mb-2">Página en mantenimiento</h1>
                <p className="text-gray-600 text-lg">Estamos trabajando para traerte una mejor experiencia. ¡Vuelve pronto!</p>
            </div>
